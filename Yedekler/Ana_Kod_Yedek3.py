...
YAKIN_INIS_IRTIFA = 0.20
LAND_GECIS_IRTIFA = 0.30

YERDE_KABUL_IRTIFA = 0.22
BEKLEME_BASLAT_IRTIFA = 0.12
YERDE_KABUL_HIZ = 0.35
YERDE_ONAY_SURESI = 1.0

LAND_TAKILMA_SURESI = 3.0
LAND_KURTARMA_IRTIFA = 0.18
LAND_KURTARMA_SURESI = 5.0
LAND_KURTARMA_MAX_DENEME = 2
