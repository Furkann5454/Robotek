...
HEDEF_YUKSEKLIK = 10          # Geçen gerçek uçuşta kullanılan görev irtifası
HEDEF_MESAFE = 1.2            # Hedefe 1.2 m yaklaşınca ulaşıldı kabul edilir
INIS_SONRASI_BEKLEME = 0     # Hedefe indikten sonra yerde 3 sn bekleme


STABIL_MESAFE = 1.2           # Hedef üstünde stabil kabul için mesafe eşiği
STABIL_HIZ = 0.4              # Hedef üstünde stabil kabul için hız eşiği
STABIL_SURE = 2.0             # Bu şartlar 1 sn sağlanırsa stabil kabul edilir


WPNAV_INIS_HIZI = 100        # Aşağı iniş hızı, 250 cm/s = 2.5 m/s

YAKIN_INIS_IRTIFA = 4.50      # LAND öncesi GUIDED ile gidilecek yakın iniş hedefi # 0.30
LAND_GECIS_IRTIFA = 5.00      # 0.60 m altına düşünce LAND moduna geçilir          # 0.40
...
LAND_KURTARMA_IRTIFA = 0.35      # Takılırsa GUIDED ile 0.22 m hedeflenir
...
MAKS_HOME_MESAFESI = 400      # Home'dan 120 m uzaklaşırsa failsafe
MAKS_IRTIFA = 40             # 30 m üstü irtifa limiti
